...
func (m *pipelineMockStore) UpdateDeployment(_ context.Context, _ *core.Deployment) error {
	return nil
}

func (m *pipelineMockStore) ListDeploymentsByStatus(_ context.Context, _ string) ([]core.Deployment, error) {
	return nil, nil
}
