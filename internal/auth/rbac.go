...
const (
	...
	PermVolumeManage         = "volume.manage"
	PermRegistryManage       = "registry.manage"
	PermBackupCreate         = "backup.create"
	PermBackupRestore        = "backup.restore"
	PermGitManage            = "git.manage"
	PermMarketplaceDeploy    = "marketplace.deploy"
	PermTopologyManage       = "topology.manage"
	PermTopologyDeploy       = "topology.deploy"
	PermWebhookManage        = "webhook.manage"
	PermDeployFreezeManage   = "deploy.freeze.manage"
	PermDeployApprovalManage = "deploy.approval.manage"
	PermAdminAll             = "*"
)
