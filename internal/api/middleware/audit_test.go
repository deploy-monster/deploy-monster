...
func (s *auditMockStore) ListDeploymentsByStatus(_ context.Context, _ string) ([]core.Deployment, error) {
	return nil, nil
}
func (s *auditMockStore) UpdateDeployment(_ context.Context, _ *core.Deployment) error {
	return nil
}
