...
// CircuitBreakerRegistry manages named circuit breakers for different services.
...
// Get returns the circuit breaker for the given service name, creating one if needed.
